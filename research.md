...
Starting in 2019, I've been working on the theory of sparsification of artificial neural networks, in particular in connection to the Lottery Ticket Hypothesis ([LTH22], [SLTH23], [RSS23], [SSLT24]) and on other problems in machine learning ([HID23], [CAID23], [SCHED24], [GENE25]).
...
problems of Consensus ([StabCons16], [NoisyUnd20]), Majority Consensus ([SimpleDyn17], [UndDyn15], [PhaseTrans18]), and Distributed Clustering ([DistCom15], [MetaStab19], [PPComDet18], [FYPComDet20]), where I have contributed
